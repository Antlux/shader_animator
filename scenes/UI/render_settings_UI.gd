...
func update_values() -> void:
	...
	frame_rate_spin_box.set_value_no_signal(Global.render_settings.frame_count / Global.render_settings.duration)
...
func _on_frame_rate_changed(value: float) -> void:
	Global.render_settings.frame_count = value * Global.render_settings.duration
